...
FAMILY_LIBRARY: Dict[str, BehaviorFamily] = {
    ...
    "raw_fruit": BehaviorFamily(
        ...
        (method(
            ...
            "assemble", ("canned", "dried", "shelf stable"), "no-cook counter",
            "prepared fruit component", 2, 0, 2, .3, "counter", "finish",
            "Drain canned {name}, reserving useful juice when the meal needs it; portion dried forms and cut large pieces as needed.",
            "Add {name} during assembly or the recipe's trained finishing stage.",
            "Distinct fruit flavor with its packaged texture intact.", "Portioned, drained when needed, and ready to use.",
            "Treating canned or dried fruit like whole fresh fruit creates impossible prep instructions.",
            "Drain excess liquid or adjust the portion before adding it.", "good",
        ),),
        ("no-cook-default",),
    ),
}
